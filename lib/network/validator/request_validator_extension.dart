    ...
    switch (this) {
      case RequestCompletionStatusEnums.badCertificate:
        return RequestCompletionHelperModel(
            ...
            responseCompletionStatus:
                RequestCompletionStatusEnums.badCertificate);
      ...
      case RequestCompletionStatusEnums.connectTimeOut:
        return RequestCompletionHelperModel(
            ...
            isSuccess: false,
            responseCompletionStatus:
                RequestCompletionStatusEnums.connectTimeOut);
      ...
      case RequestCompletionStatusEnums.receiveTimeOut:
        return RequestCompletionHelperModel(
            ...
            isSuccess: false,
            responseCompletionStatus:
                RequestCompletionStatusEnums.receiveTimeOut);
      case RequestCompletionStatusEnums.sendTimeOut:
        return RequestCompletionHelperModel(
            reason: "Send Timeout. (Dio)",
            isSuccess: false,
            responseCompletionStatus: RequestCompletionStatusEnums.sendTimeOut);
      case RequestCompletionStatusEnums.connectionError:
        return RequestCompletionHelperModel(
            reason: "Connection Error. (Dio)",
            isSuccess: false,
            responseCompletionStatus:
                RequestCompletionStatusEnums.connectionError);
      default:
        return RequestCompletionHelperModel(
